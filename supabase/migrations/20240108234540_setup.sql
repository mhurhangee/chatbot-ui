...
AS $$
DECLARE
  project_url TEXT := 'https://xnmnztbvckjpbdszomht.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhubW56dGJ2Y2tqcGJkc3pvbWh0Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxOTI2MDY3MiwiZXhwIjoyMDM0ODM2NjcyfQ.v5e-wciAsrIjFHyoGPHNRm_Wg5XnnBQ-0DqBL0SR1MI'; -- full access needed for http request to storage
